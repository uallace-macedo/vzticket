...
export function EventFooter({ ticketPrice, quantity, onCheckout }: EventFooterProps) {
  const feePerTicket = ticketPrice * 0.05;
  const totalPrice = (ticketPrice + feePerTicket) * quantity;
